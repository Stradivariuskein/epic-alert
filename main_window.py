...
class App(QDialog):
    def __init__(self, games=None):
        ...
        self.games = games
        print(f"images: {self.download_images()}")
    ...
    def download_images(self):
        if self.games is not None:
            ...
            for i in range(len(self.games)):
                ...
                pixmap.loadFromData(requests.get(self.games[i].img_src).content)
    ...
    def show_game(self):
        ...
        self.ui.title_game.setText(self.games[self.index_game].title_game.upper())
        self.ui.expiration.setText(self.games[self.index_game].expiration.upper())
        # en la primera iteracion no hay una funcion asignada
        try:
    ...
    def set_background_img(self, element=None, index_game=None):
        ...
        try:
            ...
            element.setPixmap(QtGui.QPixmap())
    ...
    def put_elements_windows(self):
        ...
        self.ui.background_layout.addWidget(self.ui.next_background_img, 0, 0, 2, 1)
    ...
    def _set_animation_slide_next(self, current: QWidget, next: QWidget, next_start_position: int):
            ...
            rect = QRect(int( - (WINDOWS_WIDTH * .2)), 0, WINDOWS_WIDTH, WINDOWS_HEIGHT)
            current_move_animation.setKeyValueAt(0.4, rect)
            rect = QRect(int( - (WINDOWS_WIDTH * .8)), 0, WINDOWS_WIDTH, WINDOWS_HEIGHT)
    ...
    def _set_animation_slide_back(self, current: QWidget, next: QWidget, next_start_position: int):
        ...
        current_move_animation.setStartValue(rect)
        rect = QRect(int((WINDOWS_WIDTH * 0.2)), 0, WINDOWS_WIDTH, WINDOWS_HEIGHT)
        current_move_animation.setKeyValueAt(0.4, rect)
        rect = QRect(int((WINDOWS_WIDTH * .8)), 0, WINDOWS_WIDTH, WINDOWS_HEIGHT)
        current_move_animation.setKeyValueAt(0.8, rect)
        rect = QRect(WINDOWS_WIDTH, 0, WINDOWS_WIDTH, WINDOWS_HEIGHT)
        ...
        next_move_animation.setStartValue(rect)
        rect = QRect(int(next_start_position+(WINDOWS_WIDTH * .2)),0, WINDOWS_WIDTH, WINDOWS_HEIGHT)
        next_move_animation.setKeyValueAt(0.4, rect)
        rect = QRect(int(next_start_position+(WINDOWS_WIDTH * .8)),0, WINDOWS_WIDTH, WINDOWS_HEIGHT)
        next_move_animation.setKeyValueAt(0.8, rect)
        rect = QRect(0, 0, WINDOWS_WIDTH, WINDOWS_HEIGHT)
        next_move_animation.setKeyValueAt(1, rect)
    ...
    def set_animation_next(self):
        ...
        self._set_animation_slide_next(self.ui.background_img, self.ui.next_background_img, start_next_position)
    
    def set_animation_back(self):
        start_next_position = -WINDOWS_WIDTH
        self.set_background_img(element=self.ui.next_background_img)
        self.set_background_img(index_game=self.index_game + 1)
        self._set_animation_slide_back(self.ui.background_img, self.ui.next_background_img, start_next_position)
